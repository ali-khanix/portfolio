...
const info = [
  {
    icon: <FaPhoneAlt />,
    title: "Phone",
    description: "(+98) 910 888 76 32",
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "khaniali568@gmail.com",
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "Alborz, Karaj, Fardis, Davari st.",
  },
];
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            ...
            >
              ...
              <Select>
                ...
                <SelectContent>
                  <SelectGroup>
                    <SelectLabel value="service">Select a service</SelectLabel>
